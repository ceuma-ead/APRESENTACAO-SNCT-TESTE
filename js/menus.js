            ...
            emptyMessage.innerHTML = `
                ...
                <div class="d-flex align-items-center justify-content-center h-100">
                    <div class="text-center p-4">
                        ...
                        <div class="flex row alert alert-warning" role="alert">
                            <i data-lucide="brain-circuit"></i>
                            <p style="font-size:0.8rem;">As mensagens são geradas por inteligência artificial. Algumas respostas podem ser incorretas ou inadequadas.</p>
                        </div>
                    </div>
                </div>
